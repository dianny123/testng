...
public class Listeners1
    ...
    public void onStart(ISuite suite) {
        GetMessages.getMessages().add("1_org.testng.ISuiteListener.onStart(ISuite suite)");
    }

    @Override
    public void onFinish(ISuite suite) {
        GetMessages.getMessages().add("1_org.testng.ISuiteListener.onFinish(ISuite suite)");
    }
